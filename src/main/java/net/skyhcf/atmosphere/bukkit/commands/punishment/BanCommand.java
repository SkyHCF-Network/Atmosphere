...
public class BanCommand {
    ...
    @Command(names = {"ban"}, permission = "atmosphere.punishments.ban")
    public static void ban(CommandSender sender, @Param(name = "target")Profile target, @Flag(value = {"p", "public"}, defaultValue = true) boolean silent, @Param(name = "reason", wildcard = true) String reason){
