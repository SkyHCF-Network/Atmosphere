...
public class TempBanCommand {
    ...
    @Command(names = {"tban", "tb", "tempban"}, permission = "atmosphere.punishments.tempban")
    public static void tempban(CommandSender sender, @Param(name = "target")Profile target, @Param(name = "duration") String time, @Flag (value = {"p", "public"}, defaultValue = true) boolean silent, @Param(name = "reason", wildcard = true) String reason){
