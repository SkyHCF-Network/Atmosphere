...
public class BlacklistCommand {
    ...
    @Command(names = {"blacklist"}, permission = "atmosphere.punishments.blacklist")
    public static void blacklist(CommandSender sender, @Param(name = "target") Profile target, @Flag(value = {"p", "public"}, defaultValue = true) boolean silent, @Param(name = "reason", wildcard = true) String reason){
