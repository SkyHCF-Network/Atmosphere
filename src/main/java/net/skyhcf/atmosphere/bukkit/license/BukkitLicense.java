package net.skyhcf.atmosphere.bukkit.license;

import net.skyhcf.atmosphere.shared.utils.BukkitLogger;
...
public class BukkitLicense {
    ...
    private String securityKey = "PBnYo2wOL0RMPqneAJjLu81kD5l4izQI5yfX";
    private boolean debug = false;

    public BukkitLicense(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public BukkitLicense setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public BukkitLicense setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public BukkitLicense debug() {
        debug = true;
        return this;
    }

    public boolean register() {
        BukkitLogger.log("License System", "Validating license...");
        ValidationType vt = isValid();
        if (vt == ValidationType.VALID) {
            BukkitLogger.log("License System", "License is currently valid.");
            return true;
        } else {
            BukkitLogger.log("License System", "License is currently invalid. Atmosphere will be disabled for security purposes.");
